...
aws_kms_decrypt 'default' do
  ...
  # DO NOT DO THIS! This is for testing. It's pretty much a terrible idea. If your setting your keys in code somewhere, 
  # and storing it in SCM, YOUR DOING IT WRONG.
